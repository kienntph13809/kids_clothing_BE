...
INSERT INTO `account` (`id`, `capcha`, `email`, `is_delete`, `one_time_password`, `otp_requested_time`, `password`,
                       `phone`, `username`)
VALUES (1, NULL, NULL, b'0', NULL, '2021-12-21 00:23:06',
        '$2a$12$xV/HkPLgQhhC3HTA5jcgse6Ruu2OPaBcq.A.ckpbfdBGz89troxx.', NULL, 'admin'),
       (2, NULL, '', b'0', '', '2021-12-21 00:23:06', '$2a$12$xV/HkPLgQhhC3HTA5jcgse6Ruu2OPaBcq.A.ckpbfdBGz89troxx.',
        NULL, 'staff'),
       (3, NULL, 'datdtph09768@fpt.edu.vn', b'0', NULL, '2021-12-21 00:23:06',
        '$2a$12$xV/HkPLgQhhC3HTA5jcgse6Ruu2OPaBcq.A.ckpbfdBGz89troxx.', '0369332232', 'customer'),
       (4, NULL, 'ducmc012@gmail.com', b'0', NULL, '2021-12-22 00:52:09',
        '$2a$10$1HYLgJYVI.pRpkoara/27OtpbZJffpwx7WSBFqDs3x2kqDTTcMKr2', '0334778629', 'ducmc'),
       (5, NULL, 'dathvph10953@fpt.edu.vn', b'0', NULL, '2021-12-22 01:39:37',
        '$2a$10$UcjVuBWh4ZIn5J4r6KBJF.xS532IK2RMYk1XUoixw3gILz4sp.LMG', '0987820633', 'dathv'),
       (6, NULL, 'luuquanghung@gmail.com', b'0', NULL, '2023-03-09 16:05:24',
        '$2a$12$7X73bcweShKyarLNM/aU9ud43GuSBMcw62je20Gdnx74du8727jtO', '0867621485', 'luuquanghung'),
       (7, NULL, 'hunglqph09776@fpt.edu.vn', b'0', NULL, '2023-03-20 22:16:38',
        '$2a$10$yLVjCXlxg19IKMpAsuCfQO9DUCcnur0d7K0qEVHHBUgv4ZdIX0.1O', '12345', 'hung123');
...
INSERT INTO `authority` (`id`, `idaccount`, `idrole`, `is_delete`)
...
INSERT INTO `bill` (`id`, `address`, `create_at`, `discount`, `downtotal`, `full_name`, `idcustomer`, `is_delete`,
                    `note`, `note_refund`, `payment`, `refund`, `phone_number`, `status`, `statusshipping`, `total`,
                    `transport_fee`, `update_at`, `voucher_id`)
VALUES ('32594297', 'cẩm bình cẩm thủy thanh hóa', '2023-03-21 00:34:59', 0, 1075500, 'Khách hàng', 1, b'0', NULL, NULL,
        b'0', NULL, '0369332232', 'CHUA_XAC_NHAN', 'Đang xử lý', 1045500, 30000, '2023-03-21 00:34:59', NULL),
       ('54071051', '14a, Xã Pải Lủng, Huyện Mèo Vạc, Tỉnh Hà Giang', '2023-03-21 00:44:51', 0, 727000, 'Khách hàng', 1,
        b'0', NULL, NULL, b'0', NULL, '0369332232', 'KHACH_DA_NHAN_HANG', 'Đang xử lý', 697000, 30000,
        '2023-03-21 00:46:31', NULL),
       ('59011169', '22a, Xã Thượng Phùng, Huyện Mèo Vạc, Tỉnh Hà Giang', '2023-03-21 00:43:46', 0, 901250,
        'Khách hàng', 1, b'0', NULL, NULL, b'0', NULL, '0369332232', 'CHUA_XAC_NHAN', 'Đang xử lý', 871250, 30000,
        '2023-03-21 00:43:46', NULL),
       ('67370224', 'Ba vì Hà Nội', '2023-03-20 22:33:28', 0, 262200, 'Lưu Quang Hưng', 4, b'0', NULL, NULL, b'0', NULL,
        '0867621485', 'CHUA_XAC_NHAN', 'Đang xử lý', 232200, 30000, '2023-03-20 22:33:28', NULL),
       ('74423513', 'cẩm bình cẩm thủy thanh hóa', '2023-03-21 00:35:15', NULL, 697000, 'Khách hàng', 1, b'0', NULL,
        NULL, b'1', NULL, '0369332232', 'CHUA_XAC_NHAN', 'Đang xử lý', 697000, 0, '2023-03-21 00:35:15', NULL);
...
INSERT INTO `category` (`id`, `is_delete`, `name`)
VALUES (1, b'0', 'Quần áo bé trai'),
...
INSERT INTO `categorydetail` (`id`, `is_delete`, `name`, `idcategory`)
VALUES (1, b'0', 'Áo bé trai', 1),
...
INSERT INTO `customer` (`id`, `address`, `fullname`, `idaccount`, `is_delete`, `statuscustomer`)
VALUES (1, 'cẩm bình cẩm thủy thanh hóa', 'Khách hàng', 3, b'0', NULL),
...
INSERT INTO `event` (`id`, `endday`, `is_delete`, `name`, `startday`)
VALUES (1, '2024-12-22 00:00:27', b'0', 'Giảm giá khi thanh toán qua ví', '2021-12-22 00:00:52');
...
INSERT INTO `history` (`idhistory`, `content`, `amounts`, `description`, `idmamipay`, `status`, `surplus`, `time`,
                       `trading_code`)
VALUES (3, 'Nap tien vao vi', 10000000, 'NAP TIEN customer', 2, b'1', 10000000, '2021-12-21 19:45:43', 1680583),
       ...
       (8, 'Thanh toán hóa đơn', 1320000, 'Thanh toán hóa đơn mã 86463036', 3, b'1', 108680000, '2021-12-22 01:10:19',
        0),
       (9, 'Thanh toán hóa đơn', 250740, 'Thanh toán hóa đơn mã 47985376', 3, b'1', 108429260, '2021-12-22 01:17:00',
        0),
       (10, 'Thanh toán hóa đơn', 1337600, 'Thanh toán hóa đơn mã 11471435', 3, b'1', 107091660, '2021-12-22 01:19:05',
        0),
       (11, 'Thanh toán hóa đơn', 812700, 'Thanh toán hóa đơn mã 89364040', 3, b'1', 106278960, '2021-12-22 01:21:02',
        0),
       (12, 'Thanh toán hóa đơn', 0, 'Thanh toán hóa đơn mã 25192722', 3, b'1', 106278960, '2021-12-22 01:21:58', 0),
       (13, 'Thanh toán hóa đơn', 125370, 'Thanh toán hóa đơn mã 45665895', 3, b'1', 106153590, '2021-12-22 01:23:07',
        0),
       (14, 'Thanh toán hóa đơn', 408000, 'Thanh toán hóa đơn mã 55548279', 3, b'1', 105745590, '2021-12-22 01:24:45',
        0),
       (15, 'Thanh toán hóa đơn', 525370, 'Thanh toán hóa đơn mã 20171394', 3, b'1', 105220220, '2021-12-22 01:36:17',
        0),
       (16, 'Hoàn tiền hóa đơn', 400000, 'Hoàn tiền hóa đơn mã 25192722', 3, b'1', 105620220, '2021-12-22 01:37:06', 0),
       (17, 'Nap tien vao vi', -8.446744073709552e16, 'NAP TIEN dathv', 4, b'0', -8.446744073709552e16,
        '2021-12-22 01:44:49', 31252271),
       (18, 'Nap tien vao vi', 100000000, 'NAP TIEN dathv', 4, b'0', 100000000, '2021-12-22 01:47:47', 87079445),
       (19, 'Thanh toán hóa đơn', 334400, 'Thanh toán hóa đơn mã 52313883', 4, b'1', 999999685600,
        '2021-12-22 01:49:10', 0),
       (20, 'Thanh toán hóa đơn', 440000, 'Thanh toán hóa đơn mã 54631662', 4, b'1', 999999245600,
        '2021-12-22 01:50:06', 0),
       (21, 'Thanh toán hóa đơn', 2464000, 'Thanh toán hóa đơn mã 88625363', 4, b'1', 999996781600,
        '2021-12-22 01:50:43', 0),
       (22, 'Thanh toán hóa đơn', 348500, 'Thanh toán hóa đơn mã 25645701', 4, b'1', 999996433100,
        '2021-12-22 01:51:47', 0),
       (23, 'Thanh toán hóa đơn', 348300, 'Thanh toán hóa đơn mã 33575124', 4, b'1', 999996084800,
        '2021-12-22 01:53:08', 0),
       (24, 'Thanh toán hóa đơn', 125370, 'Thanh toán hóa đơn mã 76386631', 4, b'1', 999995959430,
        '2021-12-22 01:55:15', 0),
       (25, 'Thanh toán hóa đơn', 165000, 'Thanh toán hóa đơn mã 48180696', 4, b'1', 999995794430,
        '2021-12-22 01:57:02', 0),
       (26, 'Thanh toán hóa đơn', 400000, 'Thanh toán hóa đơn mã 10541641', 4, b'1', 999995394430,
        '2021-12-22 01:57:43', 0),
       (27, 'Hoàn tiền hóa đơn', 348500, 'Hoàn tiền hóa đơn mã 25645701', 4, b'1', 999995742930, '2021-12-22 02:19:35',
        0),
       (28, 'Hoàn tiền hóa đơn', 400000, 'Hoàn tiền hóa đơn mã 10541641', 4, b'1', 999996142930, '2021-12-22 02:19:41',
        0),
       (29, 'Thanh toán hóa đơn', 704000, 'Thanh toán hóa đơn mã 58409325', 4, b'1', 999995438930,
        '2021-12-22 02:21:49', 0),
       (30, 'Thanh toán hóa đơn', 675750, 'Thanh toán hóa đơn mã 31492628', 4, b'1', 999994763180,
        '2021-12-22 02:23:48', 0),
       (31, 'Thanh toán hóa đơn', 125370, 'Thanh toán hóa đơn mã 77067644', 3, b'1', 105494850, '2021-12-22 02:25:21',
        0),
       (32, 'Thanh toán hóa đơn', 668800, 'Thanh toán hóa đơn mã 75756012', 3, b'1', 104826050, '2021-12-22 02:29:03',
        0),
       (33, 'Thanh toán hóa đơn', 668800, 'Thanh toán hóa đơn mã 95683949', 3, b'1', 104157250, '2021-12-22 02:29:41',
        0),
       (34, 'Thanh toán hóa đơn', 3060000, 'Thanh toán hóa đơn mã 27119608', 3, b'1', 101097250, '2021-12-22 02:30:17',
        0),
       (35, 'Thanh toán hóa đơn', 298500, 'Thanh toán hóa đơn mã 29436696', 3, b'1', 100798750, '2021-12-22 02:32:49',
        0),
       (36, 'Thanh toán hóa đơn', 298500, 'Thanh toán hóa đơn mã 23831498', 3, b'1', 100500250, '2021-12-22 02:33:31',
        0),
       (37, 'Thanh toán hóa đơn', 1760000, 'Thanh toán hóa đơn mã 53792823', 3, b'1', 98740250, '2021-12-22 03:00:13',
        0),
       (38, 'Thanh toán hóa đơn', 1408000, 'Thanh toán hóa đơn mã 89244825', 3, b'1', 97332250, '2021-12-22 03:01:34',
        0),
       (39, 'Thanh toán hóa đơn', 1192000, 'Thanh toán hóa đơn mã 77484047', 3, b'1', 96140250, '2021-12-22 03:02:59',
        0),
       (40, 'Thanh toán hóa đơn', 745000, 'Thanh toán hóa đơn mã 37352255', 3, b'1', 95395250, '2021-12-22 03:03:52',
        0),
       (41, 'Thanh toán hóa đơn', 825000, 'Thanh toán hóa đơn mã 07145031', 3, b'1', 94570250, '2021-12-22 03:04:24',
        0),
       (42, 'Thanh toán hóa đơn', 1485000, 'Thanh toán hóa đơn mã 54505876', 3, b'1', 93085250, '2021-12-22 03:06:11',
        0),
       (43, 'Thanh toán hóa đơn', 825000, 'Thanh toán hóa đơn mã 81030320', 3, b'1', 92260250, '2021-12-22 03:06:56',
        0),
       (44, 'Thanh toán hóa đơn', 501600, 'Thanh toán hóa đơn mã 79887568', 3, b'1', 91758650, '2021-12-22 03:18:46',
        0),
       (45, 'Thanh toán hóa đơn', 668800, 'Thanh toán hóa đơn mã 96971020', 3, b'1', 91089850, '2021-12-22 03:19:15',
        0),
       (46, 'Thanh toán hóa đơn', 836000, 'Thanh toán hóa đơn mã 61015230', 3, b'1', 90253850, '2021-12-22 03:19:59',
        0),
       (47, 'Thanh toán hóa đơn', 1003200, 'Thanh toán hóa đơn mã 50471780', 3, b'1', 89250650, '2021-12-22 03:21:02',
        0),
       (48, 'Thanh toán hóa đơn', 1337600, 'Thanh toán hóa đơn mã 12508881', 3, b'1', 87913050, '2021-12-22 03:21:24',
        0),
       (49, 'Thanh toán hóa đơn', 2640000, 'Thanh toán hóa đơn mã 40463061', 3, b'1', 85273050, '2021-12-22 03:24:07',
        0),
       (50, 'Thanh toán hóa đơn', 3520000, 'Thanh toán hóa đơn mã 08590016', 3, b'1', 81753050, '2021-12-22 03:24:24',
        0),
       (51, 'Thanh toán hóa đơn', 1760000, 'Thanh toán hóa đơn mã 57209950', 3, b'1', 79993050, '2021-12-22 03:24:48',
        0),
       (52, 'Thanh toán hóa đơn', 2200000, 'Thanh toán hóa đơn mã 82858547', 3, b'1', 77793050, '2021-12-22 03:25:15',
        0),
       (53, 'Thanh toán hóa đơn', 880000, 'Thanh toán hóa đơn mã 12069924', 3, b'1', 76913050, '2021-12-22 03:26:18',
        0),
       (54, 'Thanh toán hóa đơn', 3520000, 'Thanh toán hóa đơn mã 02234126', 3, b'1', 73393050, '2021-12-22 03:27:28',
        0),
       (55, 'Thanh toán hóa đơn', 3080000, 'Thanh toán hóa đơn mã 58614484', 3, b'1', 70313050, '2021-12-22 03:28:34',
        0),
       (56, 'Thanh toán hóa đơn', 3168000, 'Thanh toán hóa đơn mã 50525356', 3, b'1', 67145050, '2021-12-22 03:29:18',
        0),
       (57, 'Thanh toán hóa đơn', 2464000, 'Thanh toán hóa đơn mã 79571039', 3, b'1', 64681050, '2021-12-22 03:29:37',
        0),
       (58, 'Thanh toán hóa đơn', 6600000, 'Thanh toán hóa đơn mã 08509182', 3, b'1', 58081050, '2021-12-22 03:30:10',
        0),
       (59, 'Thanh toán hóa đơn', 4800000, 'Thanh toán hóa đơn mã 26938997', 3, b'1', 53281050, '2021-12-22 03:30:37',
        0),
       (60, 'Thanh toán hóa đơn', 4200000, 'Thanh toán hóa đơn mã 05439511', 3, b'1', 49081050, '2021-12-22 03:31:11',
        0),
       (61, 'Thanh toán hóa đơn', 474000, 'Thanh toán hóa đơn mã 31087496', 3, b'1', 48607050, '2021-12-22 03:31:32',
        0),
       (62, 'Thanh toán hóa đơn', 333200, 'Thanh toán hóa đơn mã 59569593', 3, b'1', 48273850, '2021-12-22 03:32:55',
        0),
       (63, 'Thanh toán hóa đơn', 416500, 'Thanh toán hóa đơn mã 79782121', 3, b'1', 47857350, '2021-12-22 03:33:24',
        0),
       (64, 'Thanh toán hóa đơn', 1020000, 'Thanh toán hóa đơn mã 12120369', 3, b'1', 46837350, '2021-12-22 03:35:12',
        0),
       (65, 'Thanh toán hóa đơn', 345000, 'Thanh toán hóa đơn mã 78515990', 3, b'1', 46492350, '2021-12-22 03:36:22',
        0),
       (66, 'Thanh toán hóa đơn', 395000, 'Thanh toán hóa đơn mã 64069706', 3, b'1', 46097350, '2021-12-22 03:37:22',
        0),
       (67, 'Thanh toán hóa đơn', 790000, 'Thanh toán hóa đơn mã 85828747', 3, b'1', 45307350, '2021-12-22 03:37:49',
        0),
       (68, 'Thanh toán hóa đơn', 395000, 'Thanh toán hóa đơn mã 72018135', 3, b'1', 44912350, '2021-12-22 03:38:47',
        0),
       (69, 'Thanh toán hóa đơn', 4262580, 'Thanh toán hóa đơn mã 01312959', 3, b'1', 40649770, '2021-12-22 03:41:18',
        0),
...
INSERT INTO `image` (`id`, `is_delete`, `name`, `url`, `idproduct`)
VALUES (1, b'0', 'anh.jpg',
        'https://mebe-04.web4s.vn/uploads/plugin/product_items/131/tui-xach-n-venuco-madrid-g01s285-xanh-navy-rugby-polo-shirt-2-673x837-1.jpg',
        1),
       (2, b'0', 'anh.jpg',
        'https://mebe-04.web4s.vn/uploads/plugin/product_items/131/tui-xach-n-venuco-madrid-g01s285-xanh-navy-rugby-polo-shirt-3-673x837-2.jpg',
        1),
       (3, b'0', 'anh.jpg',
        'https://mebe-04.web4s.vn/uploads/plugin/product_items/131/tui-xach-n-venuco-madrid-g01s285-xanh-navy-rugby-polo-shirt-4-673x837-3.jpg',
        1),
       (4, b'0', 'anh.jpg',
        'https://mebe-04.web4s.vn/uploads/plugin/product_items/131/tui-xach-n-venuco-madrid-g01s285-xanh-navy-rugby-polo-shirt-5-673x837-4.jpg',
        1),
       (5, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-gio-kidsplaza-in-hinh-chu-cai-1y-m20t-vang-2_1_1.jpg',
        2),
       (6, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-gio-kidsplaza-in-hinh-chu-cai-1y-m20t-vang-3_1_1.jpg',
        2),
       (7, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-gio-kidsplaza-in-hinh-chu-cai-1y-m20t-vang-4_1_1.jpg',
        2),
       (8, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-gio-kidsplaza-in-hinh-chu-cai-1y-m20t-vang-5_1_1.jpg',
        2),
       (9, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-gio-kidsplaza-in-hinh-chu-cai-1y-m20t-vang-6_1_1.jpg',
        2),
       (10, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-phong-tay-ngan-be-trai-in-hinh-chu-voi-kiza-1.jpg',
        3),
       (11, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-phong-tay-ngan-be-trai-in-hinh-chu-voi-kiza-8.jpg',
        3),
       (12, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-phong-tay-ngan-be-trai-in-hinh-chu-voi-kiza-9.jpg',
        3),
       (13, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-phong-tay-ngan-be-trai-in-hinh-chu-voi-kiza-7.jpg',
        3),
       (14, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-phong-tay-ngan-be-trai-in-hinh-chu-voi-kiza-3.jpg',
        3),
       (15, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-phong-tay-ngan-be-trai-in-hinh-chu-voi-kiza-4.jpg',
        3),
       (16, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-phong-tay-ngan-be-trai-in-hinh-chu-voi-kiza-2.jpg',
        3),
       (17, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-phong-tay-ngan-be-trai-in-hinh-chu-voi-kiza-5.jpg',
        3),
       (18, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-tay-ngan-be-trai-in-hinh-o-to-kiza-5.jpg',
        4),
       (19, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-tay-ngan-be-trai-in-hinh-o-to-kiza-3.jpg',
        4),
       (20, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-tay-ngan-be-trai-in-hinh-o-to-kiza-4.jpg',
        4),
       (21, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-tay-ngan-be-trai-in-hinh-o-to-kiza-2.jpg',
        4),
       (22, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-tay-ngan-be-trai-in-hinh-o-to-kiza-6.jpg',
        4),
       (23, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-tay-ngan-be-trai-in-hinh-o-to-kiza-7.jpg',
        4),
       (24, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-tay-ngan-be-trai-in-hinh-o-to-kiza-8.jpg',
        4),
       (25, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/s/e/set-2-quan-chip-dui-be-trai-14110-ac21-size-xxl-2.jpg',
        5),
       (26, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/s/e/set-2-quan-chip-dui-be-trai-14110-ac21-size-xxl-3.jpg',
        5),
       (27, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/s/e/set-2-quan-chip-dui-be-trai-14110-ac21-size-xxl-4.jpg',
        5),
       (28, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/s/e/set-2-quan-chip-dui-be-trai-14110-ac21-size-xxl-5.jpg',
        5),
       (29, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/q/u/quan-jeans-mem-mamago-in-hinh-thuyen-buom-xanh-nhat-3.jpg',
        6),
       (30, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/q/u/quan-jeans-mem-mamago-in-hinh-thuyen-buom-xanh-nhat-4.jpg',
        6),
       (31, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/q/u/quan-jeans-mem-mamago-in-hinh-thuyen-buom-xanh-nhat-2.jpg',
        6),
       (32, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/q/u/quan-jeans-mem-mamago-in-hinh-thuyen-buom-xanh-nhat-6.jpg',
        6),
       (33, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/q/u/quan-jeans-mem-mamago-in-hinh-thuyen-buom-xanh-nhat-5.jpg',
        6),
       (34, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/q/u/quan-dui-cotton-kiza-xanh-duong_3_.jpg',
        7),
       (35, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/q/u/quan-dui-cotton-kiza-xanh-duong_2_.jpg',
        7),
       (36, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/wysiwyg/product/thoi-trang-2021/thoi-trang-be-trai/bo-quan-ao-dai-tay-be-trai-ke-soc-kidsplaza-in-su-tu-m21t-trang-vang-4.jpg',
        8),
       (37, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/wysiwyg/product/thoi-trang-2021/thoi-trang-be-trai/bo-quan-ao-dai-tay-be-trai-ke-soc-kidsplaza-in-su-tu-m21t-trang-vang-5.jpg',
        8),
       (38, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/wysiwyg/product/thoi-trang-2021/thoi-trang-be-trai/bo-quan-ao-dai-tay-be-trai-ke-soc-kidsplaza-in-su-tu-m21t-trang-vang-6.jpg',
        8),
       (39, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/wysiwyg/product/thoi-trang-2021/thoi-trang-be-trai/bo-quan-ao-dai-tay-be-trai-ke-soc-kidsplaza-in-su-tu-m21t-trang-vang-2.jpg',
        8),
       (41, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/wysiwyg/product/thoi-trang-2021/thoi-trang-be-trai/bo-quan-ao-dai-tay-be-trai-ke-soc-kidsplaza-in-o-to-trang-xanh-4.jpg',
        9),
       (42, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/wysiwyg/product/thoi-trang-2021/thoi-trang-be-trai/bo-quan-ao-dai-tay-be-trai-ke-soc-kidsplaza-in-o-to-trang-xanh-6.jpg',
        9),
       (43, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/wysiwyg/product/thoi-trang-2021/thoi-trang-be-trai/bo-quan-ao-dai-tay-be-trai-ke-soc-kidsplaza-in-o-to-trang-xanh-5.jpg',
        9),
       (44, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/wysiwyg/product/thoi-trang-2021/thoi-trang-be-trai/bo-quan-ao-dai-tay-be-trai-ke-soc-kidsplaza-in-o-to-trang-xanh-2.jpg',
        9),
       (45, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/wysiwyg/product/thoi-trang-2021/quan-ao-thoi-trang/bo-coc-tay-danh-cho-be-trai-kidsplaza-hoa-tiet-tau-ngam-deep-tour-ln21t-xanh-2.jpg',
        10),
       (46, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/wysiwyg/product/thoi-trang-2021/quan-ao-thoi-trang/bo-coc-tay-danh-cho-be-trai-kidsplaza-hoa-tiet-tau-ngam-deep-tour-ln21t-xanh-4.jpg',
        10),
       (47, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/wysiwyg/product/thoi-trang-2021/quan-ao-thoi-trang/bo-coc-tay-danh-cho-be-trai-kidsplaza-hoa-tiet-tau-ngam-deep-tour-ln21t-xanh-3.jpg',
        10),
       (48, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/wysiwyg/product/thoi-trang-2021/quan-ao-thoi-trang/bo-coc-tay-danh-cho-be-trai-kidsplaza-hoa-tiet-tau-ngam-deep-tour-ln21t-xanh-6.jpg',
        10),
       (49, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/wysiwyg/product/thoi-trang-2021/quan-ao-thoi-trang/bo-quan-ao-ba-lo-be-trai-kidsplaza-in-hinh-o-to-tt21h-do-2.jpg',
        11),
       (50, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/wysiwyg/product/thoi-trang-2021/quan-ao-thoi-trang/bo-quan-ao-ba-lo-be-trai-kidsplaza-in-hinh-o-to-tt21h-do-4.jpg',
        11),
       (51, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/wysiwyg/product/thoi-trang-2021/quan-ao-thoi-trang/bo-quan-ao-ba-lo-be-trai-kidsplaza-in-hinh-o-to-tt21h-do-5.jpg',
        11),
       (52, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/wysiwyg/product/thoi-trang-2021/quan-ao-thoi-trang/bo-quan-ao-ba-lo-be-trai-kidsplaza-in-hinh-o-to-tt21h-do-6.jpg',
        11),
       (53, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-len-be-trai-dai-tay-hello-ke-ngang-kidsplaza-nd21d-ghi-1.jpg\n',
        13),
       (54, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-len-be-trai-dai-tay-hello-ke-ngang-kidsplaza-nd21d-ghi-2.jpg\n',
        13),
       (55, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-len-be-trai-dai-tay-hello-ke-ngang-kidsplaza-nd21d-ghi-3.jpg\n',
        13),
       (56, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-len-be-trai-dai-tay-hello-ke-ngang-kidsplaza-nd21d-ghi-3.jpg\n',
        13),
       ...
       (60, b'0', 'anh.jpg',
        ...
        29),
       (61, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-so-sinh-dai-tay-kiza-in-hinh-tho-0-3m-trang-hong-1_1_2.jpg\n',
        45),
       (62, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-so-sinh-dai-tay-kiza-in-hinh-tho-0-3m-trang-hong-2_1_2.jpg\n',
        45),
       (63, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-so-sinh-dai-tay-kiza-in-hinh-tho-0-3m-trang-hong-3_1_2.jpg\n',
        45),
       (64, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-so-sinh-dai-tay-kiza-in-hinh-tho-0-3m-trang-hong-4_1_2.jpg',
        45),
       (65, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-len-be-trai-dai-tay-hello-in-hinh-ngoi-sao-kidsplaza-nd21d-xanh-hq-1.jpg\n',
        46),
       (66, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-len-be-trai-dai-tay-hello-in-hinh-ngoi-sao-kidsplaza-nd21d-xanh-hq-1.jpg\n',
        46),
       (67, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-len-be-trai-dai-tay-hello-in-hinh-ngoi-sao-kidsplaza-nd21d-xanh-hq-3.jpg\n',
        46),
       (68, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-len-be-trai-dai-tay-hello-in-hinh-ngoi-sao-kidsplaza-nd21d-xanh-hq-3.jpg\n',
        46),
       (69, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-len-be-trai-dai-tay-hello-in-hinh-ngoi-sao-kidsplaza-nd21d-xanh-hq-5.jpg',
        46),
       (70, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-len-gile-hello-hcd-be-gai-kidsplaza-nd21d-trang-1.jpg\n',
        47),
       (71, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-len-gile-hello-hcd-be-gai-kidsplaza-nd21d-trang-2.jpg\n',
        47),
       (72, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-len-gile-hello-hcd-be-gai-kidsplaza-nd21d-trang-2.jpg\n',
        47),
       (73, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-len-gile-hello-hcd-be-gai-kidsplaza-nd21d-trang-4.jpg\n',
        47),
       (74, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-len-gile-hello-hcd-be-gai-kidsplaza-nd21d-trang-5.jpg',
        47),
       (75, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-len-gile-hello-ke-xanh-be-trai-kidsplaza-nd21d-xanh-1.jpg\n',
        48),
       (76, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-len-gile-hello-ke-xanh-be-trai-kidsplaza-nd21d-xanh-2.jpg\n',
        48),
       (77, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-len-gile-hello-hcd-be-gai-kidsplaza-nd21d-trang-2.jpg\n',
        48),
       (78, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-len-gile-hello-ke-xanh-be-trai-kidsplaza-nd21d-xanh-3.jpg\n',
        48),
       (79, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-len-gile-hello-ke-xanh-be-trai-kidsplaza-nd21d-xanh-4.jpg',
        48),
       (80, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/a/o/ao-gile-so-sinh-nhung-be-gai-kidsplaza-nd21d-hong-1_1.jpg',
        49),
       (81, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-be-trai-dai-tay-cai-giua-otis-kidsplaza-nd21t-trang-xanh-1.jpg\n',
        50),
       (82, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-be-trai-dai-tay-cai-giua-otis-kidsplaza-nd21t-trang-xanh-2.jpg\n',
        50),
       (83, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-be-trai-dai-tay-cai-giua-otis-kidsplaza-nd21t-trang-xanh-3.jpg\n',
        50),
       (84, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-be-trai-dai-tay-cai-giua-otis-kidsplaza-nd21t-trang-xanh-4.jpg\n',
        50),
       (85, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-be-trai-dai-tay-cai-giua-otis-kidsplaza-nd21t-trang-xanh-5.jpg\n',
        50),
       (86, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/s/e/set-do-so-sinh-combo-6-mon-bamboo-in-hinh-gau-kidsplaza-m21h-trang-ghi-1.jpg\n',
        51),
       (87, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/s/e/set-do-so-sinh-combo-6-mon-bamboo-in-hinh-gau-kidsplaza-m21h-trang-ghi-2.jpg \n',
        51),
       (88, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/s/e/set-do-so-sinh-combo-6-mon-bamboo-in-hinh-gau-kidsplaza-m21h-trang-ghi-2.jpg\n',
        51),
       (89, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/s/e/set-do-so-sinh-combo-6-mon-bamboo-in-hinh-gau-kidsplaza-m21h-trang-ghi-5.jpg\n',
        51),
       (90, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/s/e/set-do-so-sinh-combo-6-mon-bamboo-in-hinh-gau-kidsplaza-m21h-trang-ghi-6.jpg\n',
        51),
       (91, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/body-so-sinh-dai-tay-kidsplaza-yem-in-o-to-hn21t-trang-xanh-1.jpg\n',
        52),
       (92, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-dai-tay-be-trai-phoi-cun-kidsplaza-m21t-trang-1_6.jpg\n',
        53),
       (93, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-dai-tay-be-trai-phoi-cun-kidsplaza-m21t-trang-2_6.jpg\n',
        53),
       (94, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-dai-tay-be-trai-phoi-cun-kidsplaza-m21t-trang-3_6.jpg\n',
        53),
       (95, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-dai-tay-be-trai-phoi-cun-kidsplaza-m21t-trang-3_6.jpg\n',
        53),
       (96, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-dai-tay-be-trai-phoi-cun-kidsplaza-m21t-trang-5_6.jpg\n',
        53),
       (97, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-so-sinh-dai-tay-cai-vai-kidsplaza-m21t-vang-1.jpg\n',
        54),
       (98, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-so-sinh-dai-tay-cai-vai-kidsplaza-m21t-vang-2.jpg\n',
        54),
       (99, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-so-sinh-dai-tay-cai-vai-kidsplaza-m21t-vang-3.jpg\n',
        54),
       (100, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-so-sinh-dai-tay-cai-vai-kidsplaza-m21t-vang-3.jpg\n',
        54),
       (101, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-be-gai-dai-tay-cai-vai-otis-kidsplaza-nd21t-trang-hong-1.jpg\n',
        55),
       (102, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-so-sinh-dai-tay-cai-vai-kidsplaza-m21t-vang-2.jpg\n',
        55),
       ...
       (105, b'0', 'anh.jpg',
        ...
        56),
       (106, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-be-trai-dai-tay-cai-giua-otis-kidsplaza-nd21t-trang-vang-2.jpg\n',
        57),
       (107, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-be-gai-dai-tay-cai-lech-kidsplaza-nd21d-hong-5.jpg',
        58),
       (108, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-cai-cheo-dai-tay-kidsplaza-in-hinh-gau-m21t-trang-ghi-2.jpg\n',
        59),
       (109, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-cai-cheo-dai-tay-kidsplaza-in-hinh-gau-m21t-trang-ghi-3.jpg\n',
        59),
       (110, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-cai-cheo-dai-tay-kidsplaza-in-hinh-gau-m21t-trang-ghi-4.jpg',
        59),
       (111, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-cai-cheo-dai-tay-kidsplaza-in-hinh-gau-m21t-trang-ghi-1.jpg\n',
        59),
       (112, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-be-gai-dai-tay-cai-lech-kidsplaza-nd21d-hong-1.jpg\n',
        58),
       (113, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-be-gai-dai-tay-cai-lech-kidsplaza-nd21d-hong-3.jpg\n',
        58),
       (114, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-be-gai-dai-tay-cai-lech-kidsplaza-nd21d-hong-4.jpg\n',
        58),
       (115, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-be-trai-dai-tay-cai-giua-otis-kidsplaza-nd21t-trang-vang-2.jpg\n',
        57),
       (116, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-be-trai-dai-tay-cai-giua-otis-kidsplaza-nd21t-trang-vang-3.jpg\n',
        57),
       (117, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-be-gai-dai-tay-cai-giua-otis-kidsplaza-nd21t-trang-hong-3.jpg\n',
        56),
       (118, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-cai-cheo-dai-tay-kidsplaza-in-hinh-gau-m21t-trang-ghi-1.jpg\n',
        60),
       ...
       (121, b'0', 'anh.jpg',
        ...
        60),
       (122, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/m/u/mu-len-so-sinh-hello-be-trai-ke-ghi-ngang-kidsplaza-nd21d-vang-ghi-1.jpg\n',
        61),
       (123, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/m/u/mu-len-so-sinh-hello-be-trai-ke-ghi-ngang-kidsplaza-nd21d-vang-ghi-2.jpg',
        61),
       (124, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/m/u/mu-len-so-sinh-hello-be-trai-ke-ghi-ngang-kidsplaza-nd21d-vang-ghi-2.jpg',
        61),
       (125, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/s/e/set-2-mu-so-sinh-cotton-kidsplaza-ba21-vang-1.jpg\n',
        62),
       (126, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/s/e/set-2-mu-so-sinh-cotton-kidsplaza-ba21-vang-2.jpg\n',
        62),
       (127, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/s/e/set-2-mu-so-sinh-cotton-kidsplaza-ba21-vang-3.jpg\n',
        62),
       (128, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/s/e/set-2-mu-so-sinh-cotton-kidsplaza-ba21-vang-1.jpg\n',
        63),
       ...
       (133, b'0', 'anh.jpg',
        ...
        64),
       (134, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/m/u/mu-ho-chop-kidsplaza-hn21h-hong-1.jpg\n',
        65),
       (135, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/m/u/mu-ho-chop-kidsplaza-hn21h-hong-2.jpg\n',
        65),
       (136, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/m/u/mu-ho-chop-kidsplaza-hn21h-hong-3.jpg\n',
        65),
       (137, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/m/u/mu-so-sinh-be-trai-otis-i-love-jungles-kidsplaza-nd21t-trang-vang-1.jpg\n',
        66),
       (138, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/m/u/mu-so-sinh-be-trai-otis-i-love-jungles-kidsplaza-nd21t-trang-vang-2.jpg\n',
        66),
       (139, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/m/u/mu-so-sinh-be-trai-otis-i-love-jungles-kidsplaza-nd21t-trang-vang-3.jpg\n',
        66),
       (140, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/g/i/giay-tap-di-kidsplaza-21k-s4-bo-sua-xanh-1.jpg\n',
        67),
       (141, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/g/i/giay-tap-di-kidsplaza-21k-s4-bo-sua-xanh-2.jpg\n',
        67),
       (142, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/g/i/giay-tap-di-kidsplaza-21k-s4-bo-sua-xanh-3.jpg\n',
        67),
       (143, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/g/i/giay-tap-di-kidsplaza-21k-s4-bo-sua-xanh-4.jpg\n',
        67),
       (144, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/g/i/giay-tap-di-kidsplaza-21k-s4-bo-sua-xanh-5.jpg',
        67),
       (145, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/s/e/set-2-yem-an-ct-mothers-choice-hong-xam-1.jpg\n',
        68),
       (146, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/s/e/set-2-yem-an-ct-mothers-choice-hong-xam-2.jpg\n',
        68),
       (147, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/s/e/set-2-yem-an-ct-mothers-choice-hong-xam-3.jpg',
        68),
       (148, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/_/m/_mg_0078.jpg\n', 69),
       (149, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/_/m/_mg_0078.jpg\n', 69),
       (150, b'0', 'anh.jpg',
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/_/m/_mg_0072.jpg\n', 69),
...
INSERT INTO `mamipay` (`idmamipay`, `idcustomer`, `is_delete`, `surplus`)
VALUES (2, 1, b'0', 7723000),
       (3, 2, b'0', 41518770),
...
INSERT INTO `orderdetail` (`id`, `create_at`, `downprice`, `idbill`, `idproductdetail`, `intomoney`, `is_delete`,
                           `price`, `quantitydetail`)
VALUES (176, '2023-03-20 22:33:28', 12900, '67370224', 55, 116100, b'0', 129000, 2),
...
INSERT INTO `product` (`id`, `day_update`, `description`, `description_detail`, `discount`, `image`, `is_delete`,
                       `name`, `price`, `status`, `idcategorydetail`)
VALUES (1, '2020-12-18 01:02:28',
        '%3Cp%3ECh%E1%BA%A5t%20li%E1%BB%87u%20da%20t%E1%BB%95ng%20h%E1%BB%A3p%20cao%20c%E1%BA%A5p%2C%20b%E1%BB%81n%20%C4%91%E1%BA%B9p%20Thi%E1%BA%BFt%20k%E1%BA%BF%20n%E1%BA%AFp%20g%E1%BA%ADp%2C%20kh%C3%B3a%20b%E1%BA%A5m.%3C%2Fp%3E',
        0,
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-dai-tay-be-trai-ke-soc-kidsplaza-in-su-tu-m21t-trang-vang.jpg',
        b'0', 'Bộ quần áo dài tay bé trai kẻ sọc KidsPlaza in Sư Tử M21T (Trắng Vàng)', 129000, NULL, 3),
       (9, '2020-12-18 01:02:28',
       ...
       (57, '2020-12-18 01:02:28',
        ...
        0,
        'https://cdn.kidsplaza.vn/media/catalog/product/cache/e99dffa409453610a1fc54e724b09ba6/b/o/bo-quan-ao-be-gai-dai-tay-cai-giua-otis-kidsplaza-nd21t-trang-hong-1.jpg\n',
        b'0', 'Bộ quần áo bé gái dài tay cài giữa Otis', 99500, NULL, 12);
INSERT INTO `product` (`id`, `day_update`, `description`, `description_detail`, `discount`, `image`, `is_delete`,
                       `name`, `price`, `status`, `idcategorydetail`)
VALUES (58, '2020-12-18 01:02:28',
        'B%E1%BB%99%20qu%E1%BA%A7n%20%C3%A1o%20s%C6%A1%20sinh%20cho%20b%C3%A9%20trai%20d%C3%A0i%20tay%20c%C3%A0i%20gi%E1%BB%AFa%20Otis%20KidsPlaza%20ND21T%2C%20t%E1%BB%AB%20m%C3%A0u%20s%E1%BA%AFc%20%C4%91%E1%BA%BFn%20c%C3%A1c%20h%E1%BB%8Da%20ti%E1%BA%BFt%20v%C3%A0%20v%E1%BA%A3i%20%C4%91%E1%BB%81u%20cao%20c%E1%BA%A5p.',
...
INSERT INTO `product` (`id`, `day_update`, `description`, `description_detail`, `discount`, `image`, `is_delete`,
                       `name`, `price`, `status`, `idcategorydetail`)
VALUES (94, NULL, '<p>váy rất xinh</p>', '', 10,
        'http://localhost:8080/manager/image/get/602d85ad-ad8d-430a-8866-6a3312d1ad7c.jpg', b'0', 'ao dai', 100, '', 8);
...
INSERT INTO `property` (`idproperty`, `is_delete`, `name`)
VALUES (1, b'0', 'Nâu'),
       (2, b'0', 'Trắng'),
       (3, b'0', 'Hồng'),
       (4, b'0', 'Cam'),
...
INSERT INTO `productdetail` (`id`, `idproduct`, `idproperty`, `idsize`, `is_delete`, `quantity`)
VALUES (1, 1, 1, 3, b'0', 1000),
       (2, 1, 1, 2, b'0', 1000),
       (3, 2, 6, 3, b'0', 4998),
       (4, 2, 6, 2, b'0', 4999),
       (5, 2, 6, 1, b'0', 5000),
...
INSERT INTO `role` (`id`, `is_delete`, `name`)
VALUES ('admin', b'0', 'ROLE_ADMIN'),
...
INSERT INTO `size` (`id`, `idtypesize`, `is_delete`, `name`)
VALUES (1, 1, b'0', 'S'),
       (2, 1, b'0', 'M'),
       (3, 1, b'0', 'L'),
       (4, 1, b'0', 'X'),
...
INSERT INTO `typesize` (`id`, `is_delete`, `name`)
VALUES (1, b'0', 'size áo'),
       (2, b'0', 'size quần');
...
INSERT INTO `voucher` (`id`, `amount`, `discount`, `idevent`, `is_delete`, `minimum_value`, `name`)
VALUES (2, 999996, 10, 1, b'0', 250000, 'Giảm giá 10% khi đơn hàng đạt giá trị tối thiểu đạt 250.000đ'),
